...
RUN apt-get update && apt-get install -y --no-install-recommends \
    aria2 bash-completion build-essential ca-certificates curl file git htop iproute2 libffi-dev lsof mc nano nasm net-tools netbase nethogs openssh-client psmisc python rsync silversearcher-ag time tmux wget
